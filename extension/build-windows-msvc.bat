...
cl /nologo /EHsc /O2 /LD /std:c++17 ^
  ...
  reaadr_reaper\native_host_services.cpp reaadr_reaper\native_action_registry.cpp reaadr_reaper\cue_manager_session.cpp reaadr_reaper\marker_snapshot_adapter.cpp reaadr_reaper\marker_cue_generation_command.cpp ^
  reaadr_reaper\dialogue_detection_adapter.cpp reaadr_reaper\dialogue_detection_command.cpp reaadr_reaper\cue_status_command.cpp reaadr_reaper\cue_take_count_adapter.cpp reaadr_reaper\cue_info_command.cpp reaadr_reaper\cue_info_action.cpp ^
