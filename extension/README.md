...
- `ui/` contains native presentation, controllers, and UI contracts. The
  `ui/legacy/` area holds retained native shell experiments that are not part
...
app -> ui/entry point`; the domain core must not include REAPER SDK headers.
