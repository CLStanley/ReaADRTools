...
const std::vector<ManagerPreferenceField>& manager_preference_fields()
{
  static const std::vector<ManagerPreferenceField> fields = {
    ...
    {"bg_project_timer", "Timeline SMPTE background", "overlay", ManagerPreferenceFieldType::checkbox},
    {"bg_cue_id", "Cue ID background", "overlay", ManagerPreferenceFieldType::checkbox},
    {"bg_character", "Character background", "overlay", ManagerPreferenceFieldType::checkbox},
    {"bg_cue_timecode", "Cue timecode background", "overlay", ManagerPreferenceFieldType::checkbox},
    {"bg_dialogue", "Dialogue background", "overlay", ManagerPreferenceFieldType::checkbox},
    {"bg_direction", "Notes background", "overlay", ManagerPreferenceFieldType::checkbox},
    {"bg_cue_type", "Cue type background", "overlay", ManagerPreferenceFieldType::checkbox},
    {"bg_status", "Status background", "overlay", ManagerPreferenceFieldType::checkbox},
    {"bg_metadata", "Metadata background", "overlay", ManagerPreferenceFieldType::checkbox},
